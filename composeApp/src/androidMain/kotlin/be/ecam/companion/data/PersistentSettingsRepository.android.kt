...
class PersistentSettingsRepository(appContext: Context) : SettingsRepository {
    ...
    private fun loadThemeMode(): ThemeMode {
        val stored = prefs.getString(KEY_THEME, ThemeMode.LIGHT.name) ?: ThemeMode.LIGHT.name
